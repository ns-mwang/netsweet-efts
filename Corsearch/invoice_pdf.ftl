                ...
                <table class="cs-header" style="width: 100%;">
                    <tr>
                        <td colspan="2">
                          ...
                          <img class="comp-logo" style="width: 40%; height: 40%" src="https://system.na3.netsuite.com/core/media/media.nl?id=951&amp;c=4322318&amp;h=ca49594e85c074958736" />
                        <#else>
                            <img class="comp-logo" style="width: 120%; height: 120%" src="https://system.na3.netsuite.com/core/media/media.nl?id=952&amp;c=4322318&amp;h=1f8e96c7b49c4878776e" />
                            </#if>
                        </td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <td>
                        <p class="labeled"><span>Customer Reference: </span>${record.custbody_cor_matter_number}</p>
                      	<p class="labeled"><span>Requested By: </span>${record.custbody_cor_billing_contact?keep_after(" : ")}</p>
                        <!--<p class="labeled"><span>Requested By: </span>${billcontact.firstname}&nbsp;${billcontact.lastname}</p>-->
                    </td>
                    <td align="right">
                        <p class="labeled"><span class="nameandaddress">${record.billaddress}<#if record.vatregnum?has_content><br />VAT Registration: ${record.vatregnum}</#if></span></p>
                    </td>
...
<!-- LINE 261 -->
<hr />
<!-- MW 070618: Sub Total/Total Area -->
<table class="total" style="width: 100%; margin-top: 10px;">
    <tr>
        <td colspan="4"></td>
    ...
    <tr>
        ...
        <td align="right" colspan="2">${record.custbody_cor_subtotal} ${record.currency}</td>
    </tr>
    <!-- MW 070618: Discount Total Calculation -->
    <#assign disctotal = 0>
    <#list record.item as item>
        <#if item.custcol_integer_column == 244>
    ...
    <tr>
        <td colspan="4">&nbsp;</td>
        <td align="right"><span><b>${record.discounttotal@label}</b></span></td>
        <td align="right" colspan="2">${record.custbody_cor_discount_total} ${record.currency}</td>
    </tr>
    </#if>
    <tr>
        <td colspan="4">&nbsp;</td>
        <td align="right"><b>${record.taxtotal@label} (${record.taxrate}%)</b></td>
        <td align="right" colspan="2">${record.taxtotal} ${record.currency}</td>
    </tr>
    <tr>
        <td colspan="4">&nbsp;</td>
        <td align="right" style="background-color: #e3e3e3;"><b>${record.total@label}</b></td>
        <td align="right" style="background-color: #e3e3e3;" colspan="2">${record.custbody_cor_net_total} ${record.currency}</td>
    </tr>
    <tr>
        <td colspan="4"></td>
