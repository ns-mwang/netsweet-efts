...
<#-- FILE HEADER RECORD -->
*03<#-- Always *03 --><#rt>
${setPadding(cbank.custpage_pp_custrecord_2663_bank_comp_id,"left","0",12)}<#-- WF Bank ID (5)--><#rt>
${setPadding(cbank.custpage_pp_custrecord_2663_acct_num,"left","0",12)}<#-- CSE WF Account Num (15)--><#rt>
...
${setPadding(formatAmount(getAmount(payment)),"left","0",12)}<#-- Payment Amount (10) --><#rt>
${setLength(buildEntityName(entity,true),50)}<#-- Payee Info (45-84) -->
</#list>
<#-- TRAILER RECORD -->
&${setLength("",75)}<#rt>
