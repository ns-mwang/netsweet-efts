...
<#-- FILE HEADER RECORD -->
*03<#rt>  <#-- Always *03 -->
${setPadding(cbank.custpage_pp_custrecord_2663_bank_comp_id,"left","0",12)}<#rt>  <#-- WF Bank ID (5)-->
${setPadding(cbank.custpage_pp_custrecord_2663_acct_num,"left","0",12)}<#rt>  <#-- CSE WF Account Num (15)-->
